...
namespace Gorev7P013.Migrations
{
    ...
    [Migration("20230414191258_Initialcreate")]
            ...
            modelBuilder.Entity("Gorev7P013.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 4, 14, 22, 12, 58, 411, DateTimeKind.Local).AddTicks(661),
                            Name = "Elektronik"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 4, 14, 22, 12, 58, 411, DateTimeKind.Local).AddTicks(664),
                            Name = "Bilgisayar"
                        });
                });
            ...
            modelBuilder.Entity("Gorev7P013.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 4, 14, 22, 12, 58, 411, DateTimeKind.Local).AddTicks(333),
